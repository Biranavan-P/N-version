...
'''
from mobilenet_segnet.mobilenet_segnet import MobilenetSegnetModel
import argparse
import os
from config.mobilnet_segnet.mobilenet_config import MobileNet_SegNet_Config
from dataset.dataset import Dataset

def main():
    model = MobilenetSegnetModel()
    ...
    parser.add_argument("--result_path", type=str, default="results/mobilenet", help="Result path")
    parser.add_argument("--log_path", type=str, default="logs/mobilenet", help="Log path")
